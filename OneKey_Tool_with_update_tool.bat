...
echo 其中64位绿色版PotPlayer(OpenCodec)里，包含update tool，可以一键更新Potplayer。
echo ===============================================================================
...
del /f uninstall.exe.nsis
xcopy /s /i /y ..\Data\Skins .\Skins
xcopy /s /i /y ..\Data\Update_Tool_x64_OpenCodec .\Update_Tool_x64_OpenCodec
rename .\Update_Tool_x64_OpenCodec Update_Tool
copy ..\Data\PotPlayerMini64_AutoCheckUpdate.ini .\
rename .\PotPlayerMini64_AutoCheckUpdate.ini PotPlayerMini64.ini
cd ..
